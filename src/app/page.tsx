    ...
    <div className=" h-screen bg-gradient-to-b from-green-900 to-green-300 relative">
      ...
      <div className="">
          ...
          <div className="flex relative justify-between px-5">
            <div className="justify-start w-1/2 text-[20px] font-serif text-neutral-950  bottom-0 pl-25 self-end-safe  mt-70 ml-130 ">
              <h1>E abi.802402@sxcce.edu.in</h1>
              <h2>T 6384741940</h2>
            </div>
             <div className="w-1/2  flex justify-end ml-20">
              <p className="flex text-left ml-20 mt-35  w-1/3  justify-start font-serif text-neutral-950 bottom-0 pl-25 justify-self-center mr-20">  
              </p>
            </div>
            </div>
      </div>
